...
try {
  ...
  const authorLink = page.getByRole('link', { name: 'GAME BY SPEAKY SWAN' })
  if (await authorLink.getAttribute('href') !== 'https://vk.ru/speaky_swan') throw new Error('Author link is missing or incorrect')
  if (await authorLink.getAttribute('target') !== '_blank') throw new Error('Author link should open in a new tab')
